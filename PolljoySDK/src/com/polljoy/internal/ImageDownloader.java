...
public class ImageDownloader {
	...
	void setBitmapForImageView(Bitmap bitmap, ImageView imageView) {
		try {
	...
	void imageDownloaded(Bitmap bitmap, CompletionHandler completionHandler) {
		if (completionHandler != null) {
			completionHandler.imageDownloaded(bitmap);
		}
	}
	...
	public void download(String url, ImageView imageView,
		...
		if (bitmap == null) {
			forceDownload(url, imageView, completionHandler);
		} else {
			cancelPotentialDownload(url, imageView);
			setBitmapForImageView(bitmap, imageView);
			imageDownloaded(bitmap, completionHandler);
		}
	}
	...
	private void forceDownload(String url, ImageView imageView,
		...
		if (url == null) {
			setBitmapForImageView(null, imageView);
			return;
		}
		...
		if (cancelPotentialDownload(url, imageView)) {
			...
			case CORRECT:
				task = new BitmapDownloaderTask(imageView, completionHandler);
